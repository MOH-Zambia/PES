...
df.to_csv(CHECKPOINT_PATH + 'Stage_5_Within_District_Checkpoint.csv', header=True)
...
CROW_records_final.to_csv(CLERICAL_PATH + 'Stage_5_Within_DS_Matchkey_Clerical.csv', header=True, index=False)  # Save ready for CROW
