...
# TODO update this list to use the one specific in parameters
CEN = CEN[['ml01', 'ml02', 'ml03', 'ml04', 'ml05', 'ml06', 'ml08', 'ml09', 'pid', 'p01_name', 'p02', 'p03', 'p04',
           'p05a', 'p05b', 'p06']]
...
CEN['hhid'] = CEN['province'] + CEN['district'] + CEN['sector'] + CEN['cell'] + CEN['village'] + CEN['EA'] + \
              CEN['building_number'] + CEN['hh_number']
CEN['puid'] = CEN['province'] + CEN['district'] + CEN['sector'] + CEN['cell'] + CEN['village'] + CEN['EA'] + \
              CEN['building_number'] + CEN['hh_number'] + CEN['person_id']
