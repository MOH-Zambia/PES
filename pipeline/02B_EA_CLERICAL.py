...
clerical_results.to_csv(CLERICAL_PATH + 'Stage_2_Within_EA_Matchkey_Clerical_Reformatted.csv')
...
# Save
df3.to_csv(OUTPUT_PATH + 'Stage_2_All_Within_EA_Matches.csv', header=True)
